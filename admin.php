...
$result = mysqli_query($mysqli, "SELECT * FROM tb_user ORDER BY id DESC");
?>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                $data_dp = mysqli_query($mysqli, "SELECT * FROM departments");
                ...
                <div class="boxes">
                    ...
                    <div class="box box2">
                        ...
                        <span class="text">Total Department</span>
